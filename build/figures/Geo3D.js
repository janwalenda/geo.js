define(["require", "exports", "../classes/Geo2D", "../functions/project"], function (require, exports, Geo2D_1, project_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Geo3D = void 0;
    class Geo3D extends Geo2D_1.Geo2D {
        faces;
        vertices;
        perspective;
        z;
        ...
        toCanvas3D(ctx, distance, style) {
            ...
            for (let j = 0, n_faces = this.faces.length; j < n_faces; ++j) {
                ...
                let P = (0, project_1.project)(face[0], this.perspective, distance);
